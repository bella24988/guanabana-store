...
public class Ordine implements Serializable{
	...
	private String detagliPagamento(Pagamento pagamento){
		...
		if(pagamento.getTipoPagamento().compareTo("Carta di credito")==0){
			CartaCredito cc = (CartaCredito) pagamento;
			detagli="<p class=MsoNormal><span style='font-size:14.0pt'>Carta numero: ****"+cc.getCodice().substring(12,4)+"<o:p></o:p></span></p>"+
					"<p class=MsoNormal><span style='font-size:14.0pt'>Intestatario: "+cc.getIntestatario()+"<o:p></o:p></span></p>";
			
		}else if(pagamento.getTipoPagamento().compareTo("Bonifico")==0){
